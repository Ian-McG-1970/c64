...
; todo - need to move 40 byes to zero page as they need to be access twice (left sise and right side)
...
; store list of screen pos in high and low tables
; 80x2 =160 zero page positions required
; for each of the 80 4 pixel screen pos
;  lookup mapscreenlo,x
;  store zp+0,x
;  lookup mapscreenhi,x
;  store zp+1,x

; clr-landscape
;  lda #0
;  tay
;  beq set-clr-landscape ; jmp
; set-landscape
;  lda 0x11110000
;  ldy 0x00001111
; set-clr-landscape
;  sta zp0 - or use sta $abcd
;  sta zp2 - or use sta $abcd
;...
;  sta zp76 - or use sta $abcd
;  sta zp78 - or use sta $abcd

;  tya
;  sta zp1 - or use sta $abcd
;  sta zp3 - or use sta $abcd
;...
;  sta zp77 - or use sta $abcd
;  sta zp79 - or use sta $abcd
; rts
...
HORSCROLLTAB:
!for I = 0 TO 64
  !BYTE D016_06,D016_04,D016_02,D016_00
;  !BYTE D016_00,D016_02,D016_04,D016_06
!end
