...
!ZONE DRAW_CLEAR_LANDSCAPE
DRAW_CLEAR_LANDSCAPE
       LDY #0*8 ; remove
SCN_LN_LFT_00 STA SCN,Y ;,y remove
;SCN_LN_LFT_32 STX SCN ;,Y
        LDY #1*8
SCN_LN_LFT_01 STA SCN,Y
        LDY #2*8
SCN_LN_LFT_02 STA SCN,Y
        LDY #3*8
SCN_LN_LFT_03 STA SCN,Y
        LDY #4*8
SCN_LN_LFT_04 STA SCN,Y
        LDY #5*8
SCN_LN_LFT_05 STA SCN,Y
        LDY #6*8
SCN_LN_LFT_06 STA SCN,Y
        LDY #7*8
SCN_LN_LFT_07 STA SCN,Y
        LDY #8*8
SCN_LN_LFT_08 STA SCN,Y
        LDY #9*8
SCN_LN_LFT_09 STA SCN,Y
        LDY #10*8
SCN_LN_LFT_10 STA SCN,Y
        LDY #11*8
SCN_LN_LFT_11 STA SCN,Y
        LDY #12*8
SCN_LN_LFT_12 STA SCN,Y
        LDY #13*8
SCN_LN_LFT_13 STA SCN,Y
        LDY #14*8
SCN_LN_LFT_14 STA SCN,Y
        LDY #15*8
SCN_LN_LFT_15 STA SCN,Y
        LDY #16*8
SCN_LN_LFT_16 STA SCN,Y
        LDY #17*8
SCN_LN_LFT_17 STA SCN,Y
        LDY #18*8
SCN_LN_LFT_18 STA SCN,Y
        LDY #19*8
SCN_LN_LFT_19 STA SCN,Y
        LDY #20*8
SCN_LN_LFT_20 STA SCN,Y
        LDY #21*8
SCN_LN_LFT_21 STA SCN,Y
        LDY #22*8
SCN_LN_LFT_22 STA SCN,Y
        LDY #23*8
SCN_LN_LFT_23 STA SCN,Y
        LDY #24*8
SCN_LN_LFT_24 STA SCN,Y
        LDY #25*8
SCN_LN_LFT_25 STA SCN,Y
        LDY #26*8
SCN_LN_LFT_26 STA SCN,Y
        LDY #27*8
SCN_LN_LFT_27 STA SCN,Y
        LDY #28*8
SCN_LN_LFT_28 STA SCN,Y
        LDY #29*8
SCN_LN_LFT_29 STA SCN,Y
        LDY #30*8
SCN_LN_LFT_30 STA SCN,Y
        LDY #31*8
SCN_LN_LFT_31 STA SCN,Y
       LDY #0*8
SCN_LN_LFT_32 STA SCN,Y
        LDY #1*8
SCN_LN_LFT_33 STA SCN,Y
        LDY #2*8
SCN_LN_LFT_34 STA SCN,Y
        LDY #3*8
SCN_LN_LFT_35 STA SCN,Y
        LDY #4*8
SCN_LN_LFT_36 STA SCN,Y
        LDY #5*8
SCN_LN_LFT_37 STA SCN,Y
        LDY #6*8
SCN_LN_LFT_38 STA SCN,Y
        LDY #7*8
SCN_LN_LFT_39 STA SCN,Y

        TXA
;          LDA #$0F
          LDY #0*8
SCN_LN_RGT_00 STA SCN,Y
;SCN_LN_RGT_32 STX SCN ;,Y
        LDY #1*8
SCN_LN_RGT_01 STA SCN,Y
        LDY #2*8
SCN_LN_RGT_02 STA SCN,Y
        LDY #3*8
SCN_LN_RGT_03 STA SCN,Y
        LDY #4*8
SCN_LN_RGT_04 STA SCN,Y
        LDY #5*8
SCN_LN_RGT_05 STA SCN,Y
        LDY #6*8
SCN_LN_RGT_06 STA SCN,Y
        LDY #7*8
SCN_LN_RGT_07 STA SCN,Y
        LDY #8*8
SCN_LN_RGT_08 STA SCN,Y
        LDY #9*8
SCN_LN_RGT_09 STA SCN,Y
        LDY #10*8
SCN_LN_RGT_10 STA SCN,Y
        LDY #11*8
SCN_LN_RGT_11 STA SCN,Y
        LDY #12*8
SCN_LN_RGT_12 STA SCN,Y
        LDY #13*8
SCN_LN_RGT_13 STA SCN,Y
        LDY #14*8
SCN_LN_RGT_14 STA SCN,Y
        LDY #15*8
SCN_LN_RGT_15 STA SCN,Y
        LDY #16*8
SCN_LN_RGT_16 STA SCN,Y
        LDY #17*8
SCN_LN_RGT_17 STA SCN,Y
        LDY #18*8
SCN_LN_RGT_18 STA SCN,Y
        LDY #19*8
SCN_LN_RGT_19 STA SCN,Y
        LDY #20*8
SCN_LN_RGT_20 STA SCN,Y
        LDY #21*8
SCN_LN_RGT_21 STA SCN,Y
        LDY #22*8
SCN_LN_RGT_22 STA SCN,Y
        LDY #23*8
SCN_LN_RGT_23 STA SCN,Y
        LDY #24*8
SCN_LN_RGT_24 STA SCN,Y
        LDY #25*8
SCN_LN_RGT_25 STA SCN,Y
        LDY #26*8
SCN_LN_RGT_26 STA SCN,Y
        LDY #27*8
SCN_LN_RGT_27 STA SCN,Y
        LDY #28*8
SCN_LN_RGT_28 STA SCN,Y
        LDY #29*8
SCN_LN_RGT_29 STA SCN,Y
        LDY #30*8
SCN_LN_RGT_30 STA SCN,Y
        LDY #31*8
SCN_LN_RGT_31 STA SCN,Y
       LDY #0*8
SCN_LN_RGT_32 STA SCN,Y
        LDY #1*8
SCN_LN_RGT_33 STA SCN,Y
        LDY #2*8
SCN_LN_RGT_34 STA SCN,Y
        LDY #3*8
SCN_LN_RGT_35 STA SCN,Y
        LDY #4*8
SCN_LN_RGT_36 STA SCN,Y
        LDY #5*8
SCN_LN_RGT_37 STA SCN,Y
        LDY #6*8
SCN_LN_RGT_38 STA SCN,Y
        LDY #7*8
SCN_LN_RGT_39 STA SCN,Y
        RTS
