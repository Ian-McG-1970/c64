...
BAKB_TMPB ; a=ver / y=hor / x=sprite
    STA REGX
    LDA SPRITE_BAK_TMP_LO,X
    STA .BAKB_TMPB_JMP+1
    LDA SPRITE_BAK_TMP_HI,X
    STA .BAKB_TMPB_JMP+2
    LDA SPRITE_BAK_TMP_SIZE,X ; needs to be x?
    LDX REGX ; ldx regy
...
; todo - use ora to setup high byte so only 1 table lookup is needed?
; 24  24576 96  01100000 ; buffer
; 40  40960 160 10100000 ; screen
; 56  57344 224 11100000 ; temp
...
; LDA  SB_HI+VAL,Y 
; STA  SRC+2
; ORA #BF_TB_HI_VAL ; LDA  TB_HI+VAL,Y ; change
; STA  DST+2
;}
;!MACRO TMP_SCR SRC, DST, VAL { ; temp to screen
; LDA  SC_LO+VAL,Y
...
; LDA  TB_HI+VAL,Y 
; STA  SRC+2
; ORA #SB_TB_HI_VAL l LDA SC_HI+VAL,Y ; change
; STA  DST+2
;}
