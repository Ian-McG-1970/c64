...
LDY BKY
 ...
 CLC ; todo - needs to be SEC ?

.LOOP
.SCS01 LDA $ABCD,Y
.SPA01 AND $ABCD,Y ; todo - needs to be x
.SPO01 ORA $ABCD,Y ; todo - needs to be x
.SCD01 STA $ABCD,Y

.SCS02 LDA $ABCD,Y
.SPA02 AND $ABCD,Y ; todo - needs to be x
.SPO02 ORA $ABCD,Y ; todo - needs to be x
.SCD02 STA $ABCD,Y
     
.SCS03 LDA $ABCD,Y
.SPA03 AND $ABCD,Y ; todo - needs to be x
.SPO03 ORA $ABCD,Y ; todo - needs to be x
.SCD03 STA $ABCD,Y

.SCS04 LDA $ABCD,Y
.SPA04 AND $ABCD,Y ; todo - needs to be x
.SPO04 ORA $ABCD,Y ; todo - needs to be x
.SCD04 STA $ABCD,Y

.SCS05 LDA $ABCD,Y
.SPA05 AND $ABCD,Y ; todo - needs to be x
.SPO05 ORA $ABCD,Y ; todo - needs to be x
.SCD05 STA $ABCD,Y

.SCS06 LDA $ABCD,Y
.SPA06 AND $ABCD,Y ; todo - needs to be x
.SPO06 ORA $ABCD,Y ; todo - needs to be x
.SCD06 STA $ABCD,Y

.SCS07 LDA $ABCD,Y
.SPA07 AND $ABCD,Y ; todo - needs to be x
.SPO07 ORA $ABCD,Y ; todo - needs to be x
.SCD07 STA $ABCD,Y

.SCS08 LDA $ABCD,Y
.SPA08 AND $ABCD,Y ; todo - needs to be x
.SPO08 ORA $ABCD,Y ; todo - needs to be x
.SCD08 STA $ABCD,Y
...
;  TXA
;  SBC #8 ; todo needs to be decrement all rows
;  TAX
...
SPR00_AND_LO !BYTE <SPR00_AND_0,<SPR00_AND_1,<SPR00_AND_2,<SPR00_AND_3 ; todo - needs to be -8
SPR00_AND_HI !BYTE >SPR00_AND_0,>SPR00_AND_2,>SPR00_AND_2,>SPR00_AND_3 ; todo - needs to be -8
SPR00_ORA_LO !BYTE <SPR00_ORA_0,<SPR00_ORA_1,<SPR00_ORA_2,<SPR00_ORA_3 ; todo - needs to be -8
SPR00_ORA_HI !BYTE >SPR00_ORA_0,>SPR00_ORA_2,>SPR00_ORA_2,>SPR00_ORA_3 ; todo - needs to be -8

SPR00_AND_0
 !BYTE %00000000,%00000000,%00000000,%00000000,%00000000,%00000000,%00000000,%00000000 ; todo - needs to be last first
 !BYTE %11111111,%11111111,%11111111,%11111111,%11111111,%11111111,%11111111,%11111111 ; todo - needs to be last first
SPR00_AND_1
 !BYTE %11000000,%11000000,%11000000,%11000000,%11000000,%11000000,%11000000,%11000000 ; todo - needs to be last first
 !BYTE %00111111,%00111111,%00111111,%00111111,%00111111,%00111111,%00111111,%00111111 ; todo - needs to be last first
SPR00_AND_2
 !BYTE %11110000,%11110000,%11110000,%11110000,%11110000,%11110000,%11110000,%11110000 ; todo - needs to be last first
 !BYTE %00001111,%00001111,%00001111,%00001111,%00001111,%00001111,%00001111,%00001111 ; todo - needs to be last first
SPR00_AND_3
 !BYTE %11111100,%11111100,%11111100,%11111100,%11111100,%11111100,%11111100,%11111100 ; todo - needs to be last first
 !BYTE %00000011,%00000011,%00000011,%00000011,%00000011,%00000011,%00000011,%00000011 ; todo - needs to be last first

SPR00_ORA_0
 !BYTE %11111111,%11011011,%11100111,%11011011,%11100111,%11011011,%11100111,%11111111 ; todo - needs to be last first
 !BYTE %00000000,%00000000,%00000000,%00000000,%00000000,%00000000,%00000000,%00000000 ; todo - needs to be last first
SPR00_ORA_1
 !BYTE %00111111,%00110110,%00111001,%00110110,%00111001,%00110110,%00111001,%00111111 ; todo - needs to be last first
 !BYTE %11000000,%11000000,%11000000,%11000000,%11000000,%11000000,%11000000,%11000000 ; todo - needs to be last first
SPR00_ORA_2
 !BYTE %00001111,%00001101,%00001110,%00001101,%00001110,%00001101,%00001110,%00001111 ; todo - needs to be last first
 !BYTE %11110000,%10110000,%01110000,%10110000,%01110000,%10110000,%01110000,%11110000 ; todo - needs to be last first
SPR00_ORA_3
 !BYTE %00000011,%00000011,%00000011,%00000011,%00000011,%00000011,%00000011,%00000011 ; todo - needs to be last first
 !BYTE %11111100,%01101100,%10011100,%01101100,%10011100,%01101100,%10011100,%11111100 ; todo - needs to be last first
