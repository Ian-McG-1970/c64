...
BAK_TMP_JMP  JSR   BAK_TMP_SETUP      ; jump to the place to set the right addresses for blitter, could use JMP (ZP) for same speed overall but 2 less bytes due to above setup in ZP ?
