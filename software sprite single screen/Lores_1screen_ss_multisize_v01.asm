...
.JMP  JSR   BAK_TMP_SETUP      ; jump to the place to set the right addresses for blitter
...
SPR_BAK_HGT_ADR_LO  !BYTE <BLT_SRC_09
SPR_BAK_HGT_ADR_HI  !BYTE >BLT_SRC_09
SPR_BAK_TMP_SET_LO  !BYTE <BAK_TMP_08
SPR_BAK_TMP_SET_HI  !BYTE >BAK_TMP_08
SPR_COLUMN_SIZE_BUF !BYTE 4
SPR_COLUMN_SIZE_SPR !BYTE 3
