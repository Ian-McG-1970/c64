...
MLOOP:
 ...
 LDA TV
 LDX #3
; JSR BAKB_TMPB  ; copy back buffer to temp buffer 
 LDY TV
 LDA TH
 LDX #3
...
BAK_TMP_JMP  JSR   BAK_TMP_SETUP      ; jump to the place to set the right addresses for blitter
...
TMP_SCN_JMP  JSR   TMP_SCN_SETUP      ; jump to the place to set the right addresses for blitter
...
BAKB_TMPB_08 ; copy from screen buffer to temp buffer - size 1
 ...
 +BAK_TMP .SRC09, .DST09, 8
 
 +BAK_TMP .SRC08, .DST08, 7
 +BAK_TMP .SRC07, .DST07, 6
 +BAK_TMP .SRC06, .DST06, 5
 +BAK_TMP .SRC05, .DST05, 4
 +BAK_TMP .SRC04, .DST04, 3
 +BAK_TMP .SRC03, .DST03, 2
 +BAK_TMP .SRC02, .DST02, 1
 +BAK_TMP .SRC01, .DST01, 0

 +BAK_TMP .SRC00, .DST00, -1
...
BAKB_TMPB_16 ; copy from screen buffer to temp buffer - size 2
 ...
 +BAK_TMP .SRC17, .DST17, 16
 
 +BAK_TMP .SRC16, .DST16, 15
 +BAK_TMP .SRC15, .DST15, 14
 +BAK_TMP .SRC14, .DST14, 13
 +BAK_TMP .SRC13, .DST13, 12
 +BAK_TMP .SRC12, .DST12, 11
 +BAK_TMP .SRC11, .DST11, 10
 +BAK_TMP .SRC10, .DST10, 9
 +BAK_TMP .SRC09, .DST09, 8
...
BAKB_TMPB_24 ; copy from screen buffer to temp buffer - size 3
 ...
 +BAK_TMP .SRC25, .DST25, 24

 +BAK_TMP .SRC24, .DST24, 23
 +BAK_TMP .SRC23, .DST23, 22
 +BAK_TMP .SRC22, .DST22, 21
 +BAK_TMP .SRC21, .DST21, 20
 +BAK_TMP .SRC20, .DST20, 19
 +BAK_TMP .SRC19, .DST19, 18
 +BAK_TMP .SRC18, .DST18, 17
 +BAK_TMP .SRC17, .DST17, 16
...
BAKB_TMPB_32 ; copy from screen buffer to temp buffer - size 3
 ...
 +BAK_TMP .SRC33, .DST33, 32

 +BAK_TMP .SRC32, .DST32, 31
 +BAK_TMP .SRC31, .DST31, 30
 +BAK_TMP .SRC30, .DST30, 29
 +BAK_TMP .SRC29, .DST29, 28
 +BAK_TMP .SRC28, .DST28, 27
 +BAK_TMP .SRC27, .DST27, 26
 +BAK_TMP .SRC26, .DST26, 25
 +BAK_TMP .SRC25, .DST25, 24
...
SPR_BAK_HGT_ADR_LO  !BYTE <BLT_SRC_09,<BLT_SRC_17,<BLT_SRC_25,<BLT_SRC_33
SPR_BAK_HGT_ADR_HI  !BYTE >BLT_SRC_09,>BLT_SRC_17,>BLT_SRC_25,>BLT_SRC_33
SPR_BAK_TMP_SET_LO  !BYTE <BAK_TMP_08,<BAK_TMP_16,<BAK_TMP_24,<BAK_TMP_32
SPR_BAK_TMP_SET_HI  !BYTE >BAK_TMP_08,>BAK_TMP_16,>BAK_TMP_24,>BAK_TMP_32
SPR_TMP_SCN_SET_LO  !BYTE <TMP_SCN_08,<TMP_SCN_16,<TMP_SCN_24,<TMP_SCN_32
SPR_TMP_SCN_SET_HI  !BYTE >TMP_SCN_08,>TMP_SCN_16,>TMP_SCN_24,>TMP_SCN_32
SPR_COLUMN_SIZE_BUF !BYTE 4,4,4,4
SPR_COLUMN_SIZE_SPR !BYTE 3,3,3,3
