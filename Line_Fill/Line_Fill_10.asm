...
CLEAR_LAST_RTS  LDY #0          ; get last rts stored
        ...
        LDY HOR_END
        LDA SCR_HOR_FILL_TAB-4,Y      ; hor end
        CMP SCR_HOR_FILL_TAB-4,X      ; hor start
        BEQ FILL_LINE_SAME
        CMP SCR_HOR_FILL_TAB,X
        BEQ FILL_LINE_ADJACENT    ; adjacent chars

        TAY
        LDA #R_T_S
        STA FILL_LINE,Y
        STY CLEAR_LAST_RTS +1   ; backup to clear this rts next time
...
!ZONE FILL_LINE_SAME
FILL_LINE_SAME  
SMC_SAME_LFT_TAB  LDA COLOUR01_LEFT_TAB,X   ; GET LEFTMASK
SMC_SAME_RGT_TAB    AND COLOUR01_RIGHT_TAB,Y  ; AND RIGHTMASK
...
!ZONE FILL_LINE_ADJACENT
FILL_LINE_ADJACENT
        LDY SCR_TAB3,X      ; start hor pos
        LDA (SCR),Y
        AND INVERSE_PATTERN_START_TAB,X       ; pattern
SMC_ADJ_LFT_TAB ORA COLOUR01_LEFT_TAB,X
        STA (SCR),Y
        ...
        LDA (SCR),Y
        AND INVERSE_PATTERN_END_TAB,X       ; pattern
SMC_ADJ_RGT_TAB ORA COLOUR01_RIGHT_TAB,X
        STA (SCR),Y
        RTS
...
SET_COLOUR
      ...
      STA SMC_LFT_TAB +2
      STA SMC_RGT_TAB +2
      STA SMC_SAME_LFT_TAB +2
      STA SMC_SAME_RGT_TAB +2
      STA SMC_ADJ_LFT_TAB +2
      STA SMC_ADJ_RGT_TAB +2
      LDA COLOUR_TAB,X
      STA COLOUR
      RTS

COLOURS_TAB !BYTE >COLOUR00_LEFT_TAB,>COLOUR01_LEFT_TAB,>COLOUR10_LEFT_TAB,>COLOUR11_LEFT_TAB
COLOUR_TAB  !BYTE %00000000,%01010101,%10101010,%11111111
...
COLOUR10_LEFT_TAB
!FOR X = 1 TO 32
  !BYTE %10101010,%00101010,%00001010,%00000010
!END
COLOUR10_RIGHT_TAB
!FOR X = 1 TO 32
  !BYTE %10000000,%10100000,%10101000,%10101010
!END
